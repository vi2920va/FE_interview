...
#### 예시 2. return 없이도 클로저가 발생하는 다양한 경우

##### 예시 2-1. setInterval, setTimeout
...
#### 5-3. 클로저는 그 본질이 메모리를 꼐속 차지하는 개념이므로 더는 사용하지 않게 된 클로제에 대해서는 메모리를 차지하지 않도록 관리해줄 필요가 있습니다.
